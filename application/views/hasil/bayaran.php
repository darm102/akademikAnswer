						...
						<div class="panel panel-default">
							<div class="panel-body">
									...
									<div class="col-sm-12">
										...
										<h3 style="margin-top:5px;"> Tanggal mulai Bayaran: <br/> <?php echo $b->tanggal_mulai; ?> </h3>
										<h3 style="margin-top:5px;"> Tanggal terakhir Bayaran: <br/> <?php echo $b->tanggal_akhir; ?> </h3>
