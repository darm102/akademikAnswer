				...
				<div class="container">
						...
						<div class="panel panel-default">
							<div class="panel-body">
									<div class="col-sm-4">
										<img src="http://localhost/question-answer/gambar/facebook.png" class="col-sm-12 col-md-12 col-xs-12 col-lg-12 " />
									</div>
									<div class="col-sm-8">
										<h4 style="border-bottom:1px solid #eee">Hasil Jawaban:</h4>
										<ol class="breadcrumb" style="background:#ffffff;">
											<li class="active">NIDN</li>
											<li>Akademik</li>
											
										</ol>
										<h2 style="margin-top:5px;"><?php echo $b->no_induk; ?> </h2>
									
											<?php echo anchor("cari/informasi-dosen/".$b->id_dosen,"Lihat Selengkapnya &nbsp; <i class='fa fa-chevron-right'></i>",array("class"=>"btn btn-default col-sm-12 ")) ?>
									</div>
