				...
				<div class="container">
						...
						<div class="panel panel-default">
							<div class="panel-body">
									<div class="col-sm-4">
										<img src="http://ibdp.huluim.com/video/12816667?size=320x180" class="img-responsive"/>
									</div>
									<div class="col-sm-8">
										...
										<h4 style="margin-top:5px;">Syarat Mata Kuliah: </h4>
										<h2 style="margin-top:5px;"><?php echo $b->syarat; ?> </h2>
											<button class="btn btn-default col-sm-12 cari" id="<?php echo $b->id_dosen ?>"><center>Lihat Selengkapnya &nbsp; <i class="fa fa-chevron-right"></i></center></button>
									</div>
