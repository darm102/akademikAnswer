...
--
-- Host: 127.0.0.1
-- Generation Time: 12 Mar 2017 pada 15.21
...
(24, 'Siapa dosen yang memiliki nidn 1001'),
(25, 'siapa dosen yang memiliki nidn 1002'),
(26, 'kapan mata kuliah information retival dimulai'),
(27, 'kapan mata kuliah information retival mulai'),
(28, 'kapan jadwal bayaran semester genap'),
(29, 'apa nomor induk dosen nasional latius hermawan'),
(30, 'apa nidn kaprodi informatika'),
(31, 'apa nidn kantin informatika'),
(32, 'siapa kaprodi informatika'),
(33, 'apa nidn koordinator kp informatika'),
(34, 'kapan jadwal mulai bayaran semester genap'),
(35, 'kapan jadwal dimulainya bayaran semester genap'),
(36, 'kapan jadwal terakhir bayaran semester genap'),
(37, 'kapan jadwal pengisian krs semester genap'),
(38, 'kapan jadwal pengisian kartu rencana studi semester genap'),
(39, 'kapan jadwal me kartu rencana studi semester genap'),
(40, 'kapan jadwal mengisi krs semester genap'),
(41, 'kapan jadwal mengisi kartu rencana studi semester genap'),
(42, 'kapan jadwal mulai pengisian krs semester genap'),
(43, 'kapan jadwal terakhir pengisian krs semester genap'),
(44, 'kapan jadwal terakhir pengisian kartu rencana studi semester genap');
...
(1, 'bayaran', '2017-06-22', '2017-07-05', 'genap'),
(2, 'kartu rencana studi', '2017-08-11', '2017-08-14', 'genap');
...
(36, 'WH NN SC VB other other'),
(37, 'WH NN NN mata kuliah VB'),
(38, 'WH NN VB NN NN other'),
(39, 'WH NN NN NN NN other'),
(40, 'WH NN JJ NN NN other'),
(41, 'WH NN VB other other NN other'),
(42, 'WH NN NN other other NN other'),
(43, 'WH NN JJ other other NN'),
(44, 'WH NN NNP other NN other'),
(45, 'WH NN NNP NN other NN other'),
(46, 'WH NN NNP NN NNP other NN other'),
(48, 'WH other mata kuliah other'),
(49, 'WH NN other NN NNP other NN other other'),
(50, 'WH NN NNP NN nama '),
(51, 'WH NN NNP NN NNP NN nama '),
(52, 'WH NN NNP nama '),
(53, 'WH NN NNP NN NNP nama'),
(54, 'WH NN other other NN other'),
(55, 'WH NN other other other other NN other'),
(56, 'WH NN VB other NN other'),
(57, 'WH NN VB other other other NN other'),
(58, 'WH NN JJ other other NN other'),
(59, 'WH NN JJ other other other other NN other');
...
--
ALTER TABLE `pos`
  MODIFY `id_pos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
...
--
ALTER TABLE `whitepos`
  MODIFY `id_whitepos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
